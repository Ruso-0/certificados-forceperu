      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <h3 className="text-xl font-bold mb-2">FORCE PERÚ SAC</h3>
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-lg font-semibold mb-4 text-brand-light">
              Enlaces Rápidos
            </h4>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-3">
                <Icon name="location_on" size="sm" className="text-brand-light mt-0.5" />
                <span className="text-white/70 text-sm">
                  Lima, Perú
                </span>
              </li>
              <li className="flex items-center gap-3">
                <Icon name="phone" size="sm" className="text-brand-light" />
              ...
              <li className="flex items-center gap-3">
                <Icon name="chat" size="sm" className="text-green-400" />
                <a
              ...
              <li className="flex items-center gap-3">
                <Icon name="schedule" size="sm" className="text-brand-light" />
                <span className="text-white/70 text-sm">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
            <p className="text-white/50 text-sm text-center sm:text-left">
              &copy; {currentYear} Force Perú S.A.C. Todos los derechos reservados.
            </p>
            <div className="flex gap-4 text-sm">
              <Link to="/admin/login" className="text-white/50 hover:text-white transition-colors">
                Admin
              </Link>
              <Link to="/verificar" className="text-white/50 hover:text-white transition-colors">
